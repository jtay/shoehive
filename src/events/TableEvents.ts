...
export interface DefaultTableEventPayloadMap {
    ...
    [TABLE_EVENTS.STATE_UPDATED]: { table: Table, state: unknown };
    [TABLE_EVENTS.ATTRIBUTE_CHANGED]: { table: Table, key: string, value: unknown };
    [TABLE_EVENTS.ATTRIBUTES_CHANGED]: { table: Table, changedKeys: string[], attributes: Record<string, unknown> };
    ...
    [TABLE_EVENTS.DECK_CARD_DRAWN]: { table: Table, deckId: string, card: unknown };
    [TABLE_EVENTS.CARD_DEALT]: { table: Table, player: Player, card: unknown };
