...
export class TableFactory {
   ...
   */
  public createTable({ totalSeats, maxSeatsPerPlayer, id, gameId, options }: { totalSeats: number, maxSeatsPerPlayer: number, id?: string, gameId?: string, options?: Record<string, unknown> }): Table {
